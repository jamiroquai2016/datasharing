How to share data with a statistician PokeFortress
===========
...
and sources of delay in the transition from data collection to data analysis. The [PokeFortress](http://www.pokefortress.com/) works with a large
...
1. The raw data.
2. A [Pokefortress](http://www.pokefortress.com/) 
...
* The complicated [JSON](http://en.wikipedia.org/wiki/JSON) data you got from scraping the [PokeFortress](http://www.pokefortress.com/)
